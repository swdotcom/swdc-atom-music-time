 ...
 */
    ...
    async updateRecommendations(
        ...
        //     dataMgr.allRecommendationTracks = utilMgr.sortTracks(dataMgr.allRecommendationTracks);
        // }
        ...
        if(dataMgr.rectype != dataMgr.currentRecMeta.label) {
            dataMgr.playingTracks = [];
        }
        // if (tracks && tracks.length > 0) {
        //     // sort them alpabeticaly
    ...
    playRecommendationsOrLikedSongsByPlaylist = (
        ...
        if (isRecommendationTrack) {
            ...
            if (dataMgr.playingTracks && dataMgr.playingTracks.length > 0) {
                offset = dataMgr.playingTracks.findIndex(
                    (t) => trackId === t
                );
                 // play the list of recommendation tracks
                track_ids = dataMgr.playingTracks;
            } else {
