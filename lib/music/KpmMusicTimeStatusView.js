...
$(document).ready(function() {
    ...
    $(document).on('click', '.add-song', function(e) {
        ...
        $(_self).attr('node-id') ? localStorage.setItem(
...
export default class KpmMusicTimeStatusView {
    ...
    async display(msg, icon, tooltip, track) {
        ...
        if(needsSpotifyAccess) {
            ...
            "<span id='music-time-connect'  style='cursor: pointer; display:none' title='"+tooltip+"' >  Connect Spotify  </span>";    
        } else {
            this.element.innerHTML =
            "<span id='music-time-connect'  style='cursor: pointer;' title='"+tooltip+"' >  Connect Spotify  </span>";
