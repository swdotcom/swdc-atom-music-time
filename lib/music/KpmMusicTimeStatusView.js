...
export default class KpmMusicTimeStatusView {
    ...
    async display(msg, icon, tooltip, track) {
        ...
        if(needsSpotifyAccess) {
            ...
            "<span id='music-time-href'  style='cursor: pointer; display:none' title='"+tooltip+"' >  Connect Spotify  </span>";    
        } else {
            this.element.innerHTML =
            "<span id='music-time-href'  style='cursor: pointer;' title='"+tooltip+"' >  Connect Spotify  </span>";
