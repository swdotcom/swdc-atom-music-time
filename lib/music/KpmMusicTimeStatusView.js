...
$(document).ready(function() {
    ...
    $(document).on('click', '#music-time-menu', async function() {
        atom.commands.dispatch(
            atom.views.getView(atom.workspace),
...
export default class KpmMusicTimeStatusView {
    ...
    async display(msg, icon, tooltip, track) {
        ...
        let songStateIcon =
            track.state == 'playing' ? PAUSE_CONTROL_ICON : PLAY_CONTROL_ICON;
        ...
        if (!needsSpotifyAccess) {
            this.element.innerHTML =
                "<span id='music-time-connect'  style='cursor: pointer; display:none' title='" +
                tooltip +
