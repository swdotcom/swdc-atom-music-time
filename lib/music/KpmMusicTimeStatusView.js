...
export default class KpmMusicTimeStatusView {
    ...
    async display(msg, icon, tooltip, track) {
        ...
        let currentTrackName = this.trackData && this.trackData.state != "notassigned" ? this.trackData.name : '';
        ...
        if (currentTrackName) {
            ...
            this.accountStatus.innerHTML =
                "<span id='account-status-href' style='cursor: pointer;' title='" + accountStatusMsg + "' > " +
                accountStatusMsg +
                '</span>';
        }
        ...
        await getRunningTrack().then(track => {
            ...
            if (
                ...
                footerBars[0]
                    .getItem()
                    .leftPanel.appendChild(this.currentTrack);
