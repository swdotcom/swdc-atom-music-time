...
$(document).on('change', '#category', function() {
    ...
    closeCategory();
    setTimeout(() => {
        $("[node-id="+SPOTIFY_RECOMMENDATION_SONGS_PLAYLIST_ID+"]").attr('title',filterCat.description);
    }, 2000);
...
function getCategorySelections() {
    ...
    const items = [
        // high valence
        {
            ...
            args: ['Happy', 5, [], { min_valence: 0.6, target_valence: 1 },0,true],
        },
        // high energy
        {
            label: 'Energetic',
            ...
            args: ['Energetic', 5, [], { min_energy: 0.6, target_energy: 1 },0,true],
        },
        // high danceability
        {
            label: 'Danceable',
        ...
        // Low speechiness
        {
            ...
            args: [
                ...
                5,
                [],
                { max_speechiness: 0.4, target_speechiness: 0 },0,true
            ],
        },
        // Liked songs
        {
        ...
        // Low loudness
        {
            ...
            args: [
                ...
                5,
                [],
                { max_loudness: 0.4, target_loudness: 0 },0,true
            ],
        },
    ];
