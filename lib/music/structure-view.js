...
export default class StructureView {
    ...
    async initialize(
        ...
        const initializedApp = musicMgr.initialized;
    ...
    async updateDevice() {
        const devicesFound = await KpmMusicManager.getInstance().getActiveSpotifyDevicesButton()
    ...
    recommendTreeGenerator() {
        ...
        console.log("my recommendations: ", item);
