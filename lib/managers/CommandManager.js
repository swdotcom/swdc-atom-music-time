...
import {
    GITHUB_ISSUE_URL,
    FEEDBACK_URL,
    CONNECT_SPOTIFY_MENU_LABEL, DEFAULT_CURRENTLY_PLAYING_TRACK_CHECK_SECONDS } from '../Constants';

const utilMgr = require('./UtilManager');
const deviceMgr = require('../music/DeviceManager');
const spotifyClient = require("../music/SpotifyClient");
const kpmMgr = require("./KpmManager");
...
commandMgr.addCommands = async subscriptions => {
    ...
    subscriptions.add(
        atom.commands.add('atom-workspace', {
            'Music-Time:disconnectSpotify': () =>
                spotifyClient.disconnectSpotify(),
        })
    );
    ...
    subscriptions.add(
      atom.commands.add("atom-workspace", {
        "Music-Time:process-keystrokes-data": event => {
