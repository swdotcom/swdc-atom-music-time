...
utilMgr.getVersion = () => {
    return  atom.packages.getLoadedPackage('music-time').metadata
            .version;
...
utilMgr.spotifyConnectStatusHandler = tryCountUntilFound => {
    ...
    return __awaiter(this, void 0, void 0, function*() {
        ...
        if (!oauthResult.loggedOn) {
            ...
            // const KpmMusicStoreManagerObj = KpmMusicStoreManager.getInstance();
            // const isSpotifyPremium = KpmMusicStoreManagerObj.isSpotifyPremium();
...
utilMgr.notifyButton = (title, msg, buttons) => {
    atom.notifications.addInfo(title, { detail: msg, buttons: buttons, dismissable: true });
};
